  ...
  plugins: [
    new ModuleFederationPlugin({
      ...
      exposes: {
        ...
        "./CircularProgress": "./src/CircularProgress",
        "./Container": "./src/Container",
        "./CssBaseline": "./src/CssBaseline",
        "./DataGrid": "./src/DataGrid",
        "./Dialog": "./src/Dialog",
        "./DialogActions": "./src/DialogActions",
        "./DialogContent": "./src/DialogContent",
        "./DialogContentText": "./src/DialogContentText",
